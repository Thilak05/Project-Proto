...
// Data for symptom categories, subcategories, and symptoms
const subcategories = {
...
// Display subcategories and symptoms
function showSubcategories(category) {
  ...
  if (subcategories[category]) {
      subcategories[category].forEach(subcategory => {
          ...
          subcatDiv.classList.add('subcategory');
          subcatDiv.innerHTML = `<h3>${subcategory}</h3>`;

          symptomsList[subcategory].forEach(symptom => {
